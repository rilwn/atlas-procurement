<template>
  <div
    class="flex flex-wrap gap-10 justify-between items-center px-6 py-4 w-full text-xs leading-none text-center max-md:px-5 max-md:max-w-full"
  >
    <h1 class="self-stretch my-auto font-semibold uppercase text-blue-950">
      PROCUREMENT DASHBOARD
    </h1>
    <div
      class="flex gap-2 items-center self-stretch my-auto tracking-tight font-[590]"
    >
      <button
        class="flex items-center cursor-pointer self-stretch px-2 my-auto whitespace-nowrap bg-white rounded-md border-2 border-solid border-gray-100 border-opacity-10 min-h-[32px] text-[token('color.text')]"
      >
        <div
          class="flex gap-1 justify-center items-center self-stretch my-auto"
        >
          <svg
            width="24"
            height="24"
          ...
          <span class="self-stretch my-auto">Filter</span>
        </div>
      </button>
      <button
        class="flex justify-center cursor-pointer items-center self-stretch py-0.5 pr-2 pl-1 my-auto bg-blue-600 rounded-md min-h-[32px] text-[token('color.text.inverse')]"
      >
        <div
          class="flex gap-1 justify-center items-center self-stretch my-auto"
        >
          ...
          <span class="text-white self-stretch my-auto">Download Report</span>
        </div>
      </button>
    </div>
  </div>
